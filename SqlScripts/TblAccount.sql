...
INSERT INTO runtime.Account (EmployeeId, AcctPassword, FirstName, LastName, Email, AccountRequestId)
	SELECT EmployeeId, AcctPassword, FirstName, LastName, Email, AccountRequestID FROM runtime.AccountRequest WHERE AccountApproval = 'A'
;
